...
No build step is required. A central index page lists all available demos.
1. Clone the repository.
2. Navigate to the project directory.
3. Open `src/index.html` in your browser. Use the navigation bar to switch between demos.
